...
# Load Model Function
def load_saved_model(model_dir='saved_model', model_name='project2_part2_model.h5'):
...
def test_model(data_path):
    model = load_saved_model(model_dir='saved_model', model_name='project2_part2_model.h5')
